...
RISCVTOOLS=/class/ece411/software/riscv-tools
# Flag: RISCVTYPE
...
#PORT_CFLAGS = -O2 -static -std=gnu99 -flto -s
#PORT_CFLAGS = -Wall -Wextra -Wno-unused -march=rv32im -Os -flto -s -mcmodel=medany -static -std=gnu99 -fno-common -ffreestanding -nostartfiles -lm -static-libgcc -lgcc -T $(PORT_DIR)/link.ld -Xlinker -Map=output.map -Wl,--no-relax
PORT_CFLAGS = -DTOTAL_DATA_SIZE=2000 -flto -Wall -Wextra -Wno-unused -march=rv32i -Ofast -mcmodel=medany -static -std=gnu99 -fno-common -ffreestanding -nostartfiles -lm -static-libgcc -lgcc -T $(PORT_DIR)/link.ld -Wl,--no-relax
...
PORT_SRCS = $(PORT_DIR)/core_portme.c $(PORT_DIR)/startup.s
# Flag: LOAD
...
.PHONY: build_pgo_gcc
build_pgo_gcc:
	$(MAKE) PGO=gen XCFLAGS="$(XCFLAGS) -fprofile-generate -DTOTAL_DATA_SIZE=1200" ITERATIONS=1 gen_pgo_data REBUILD=1
